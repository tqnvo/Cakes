...
% 	\begin{align*}
% 		\vec{\gamma}: (-1,1) \times (0,2\pi) \to \mathbb{R}^3	
% 	\end{align*}
% 	with
% 	\begin{align*}
% 		\vec{\gamma}(t,\phi) = 
...
% 	\begin{align*}
% 		n(t,\phi) 
% 		 & = \pm \frac{\partial_t \vec{\gamma} \times \partial_{\phi} \vec{\gamma}}{||\partial_t \vec{\gamma} \times \partial_{\phi} \vec{\gamma}||} \\
% 		 & = \frac{\mp 1}{a} \begin{pmatrix}\cos(\phi) \sin(\frac{\phi}{2}) - \frac{t}{4} \sin(\phi)(1-\cos(\phi)) \\ \sin(\phi) \sin(\phi/2) + \frac{t}{4} (\sin^2(\phi)+ \cos(\phi))\\ - \cos(\phi/2) - \frac{t}{4}(1+\cos(\phi)) \end{pmatrix}
% 	\end{align*}
% 	with 
% 	\begin{align*}
...
% 	\end{cases}
% \end{align}
% \inputfig{floats/matrixA32}{matrixA32}
...
% 	\end{cases}
% \end{align}
% \inputfig{floats/matrixA21}{matrixA21}
...
% 	\end{align}
% \end{exampleboxed}
% \inputfig{floats/matrixA213132}{matrixA213132}
...
% \inputfig{floats/householder}{householder}

% Let us consider the first column of matrix $A$
% \inputfig{floats/householder_matrixA}{householder_matrixA}

% \clearpage
% \inputfig{floats/householder_projection}{householder_projection}
...
% \begin{observationboxed}[\textbf{QR-algorithm} vs. \textbf{QR-decomposition}]
...
% \end{align}
% % \begin{equation*}
% % 	\Vert u\Vert_{L^6(\Omega)}^6 = \int_{0}^{\infty} (x+2)^{-\frac{3\cdot 6}{5}}\,{\mathrm d}x
% % 	= -\left.\frac{5}{13}(x+2)^{-\frac{13}{5}}\right|_{x=0}^{x=\infty} = \frac{5}{13}\cdot 2^{-\frac{13}{5}} < \infty.    
% % \end{equation*}
...
% 	% \Vert g(x) \Vert_{L^{6/5}(\Omega)}^{6/5}
% 	 & = 
% 	\bigintsss_{0}^{\infty}
% 	|g(x)|^{6/5} \,dx
% 	\notag                                                                                                           \\
...
% Approach:\\
% We will look at the \Cref{setAinR2} and consider it in two scenarios as follows
% \begin{enumerate}
% 	\item Scenario 1: \Cref{setAinR2_Ax},
% 	\item Scenario 2: \Cref{setAinR2_Ay},
% \end{enumerate}
% which we will see later on that the two approaches will actually lead to the same solution,
% thanks to Fubini's theorem \cite{FubiniWiki}.
% \newpage
% \begin{recallboxed}
...
% 	\end{align}
% \end{recallboxed}
% By taking advantage of the formula \eqref{eq:lineeqn}
% we are ready to obtain the following three line functions for 
% $(AB)$, $(AC)$, and $(BC)$ as follows
% \begin{align}
% 	\label{eq:box1}
% 	\boxed{
% 		\begin{aligned}
% 			(AB):\quad y & = -x + 3,                     \\
% 			(AC):\quad y & = \frac{1}{2}x + \frac{3}{2}, \\
% 			(BC):\quad y & = 2\,x - 3,
% 		\end{aligned}
% 	}
% \end{align}
% which we, alternatively, we can also write those expressions in terms of $x$, as follows
% \begin{align}
% 	\label{eq:box2}
% 	\boxed{
% 		\begin{aligned}
% 			(AB):\quad x & = -y + 3,                     \\
% 			(AC):\quad x & = 2\,y - 3,                   \\
% 			(BC):\quad x & = \frac{1}{2}y + \frac{3}{2}.
% 		\end{aligned}
% 	}
% \end{align}
% Note in passing that we have used point $A(1,2)$, $B(2,1)$, and $C(3,3)$.
% \clearpage
% \begin{enumerate}
% 	\item Scenario 1: \Cref{setAinR2_Ax}\\
% 	      \inputfig{floats/setAinR2_Ax}{setAinR2_Ax}

% 	      By following the $\mathcal{M}_x$ split and using the box \eqref{eq:box1}
% 	      we obtain the set $\mathcal{M}_{1}$
% 	      \begin{align}
% 		      \mathcal{M}_{1} = 
% 		      \Big\{ y \in \mathbb{R} \, \Big| \, -x+3 \leq y \leq \frac{1}{2}x + \frac{3}{2} \Big\},
% 	      \end{align}
% 	      which is due to the fact that while following the $y$-axis we first come across 
% 	      the line $(AB)$ and then the line $(AC)$. Similarly, 
% 	      the set $\mathcal{M}_{2}$ is obtained as follows
% 	      \begin{align}
% 		      \mathcal{M}_{2} = 
% 		      \Big\{ y \in \mathbb{R} \, \Big| \, 2x-3 \leq y \leq \frac{1}{2}x + \frac{3}{2} \Big\},
% 	      \end{align}
% 	      which, again, is due the fact that we first face to the line $(BC)$ and then $(AC)$
% 	      while following the $y$-axis.
% 	      Therefore, we obtain 
% 	      \begin{align}
% 		      \bigintsss_{\mathcal{M}}f(x,y)\,d\lambda_{2}
% 		       & = \bigintsss_{\mathcal{M}_1}f(x,y)\,d\lambda_{2}
% 		      + \bigintsss_{\mathcal{M}_2}f(x,y)\,d\lambda_{2}
% 		      \notag                                                                                 \\
% 		       & = \bigintsss_{\mathbb{R}} 
% 		      ( \bigintsss_{(\mathcal{M}_1)_x} f(x,y)\,dy )\,dx
% 		      + \bigintsss_{\mathbb{R}}
% 		      ( \bigintsss_{(\mathcal{M}_2)_x} f(x,y)\,dy )\,dx
% 		      \notag                                                                                 \\
% 		       & = \bigintsss_{1=x_A}^{2=x_B} ( \bigintsss_{-x+3}^{x/2+3/2} f(x,y)\,dy ) \,dx \notag \\
% 		       & \qquad\qquad\qquad
% 		      + \bigintsss_{2=x_B}^{3=x_C} ( \bigintsss_{2x-3}^{x/2+3/2} f(x,y)\,dy ) \,dx
% 	      \end{align}
% 	      which will results in $3/2$ when $f(x,y)=1$.
% 	      \clearpage
% 	      %----------------------------------------
% 	\item Scenario 2: \Cref{setAinR2_Ay}\\
% 	      \inputfig{floats/setAinR2_Ay}{setAinR2_Ay}

% 	      By following the $\mathcal{M}_y$ split and using the box \eqref{eq:box2}
% 	      we obtain the set $\mathcal{M}_{3}$
% 	      \begin{align}
% 		      \mathcal{M}_{3} = 
% 		      \Big\{ x \in \mathbb{R} \, \Big| \, -y+3 \leq x \leq \frac{1}{2}y + \frac{3}{2} \Big\},
% 	      \end{align}
% 	      which is due to the fact that while following the $x$-axis we first come across 
% 	      the line $(AB)$ and then the line $(BC)$. Similarly, 
% 	      the set $\mathcal{M}_{4}$ is obtained as follows
% 	      \begin{align}
% 		      \mathcal{M}_{4} = 
% 		      \Big\{ x \in \mathbb{R} \, \Big| \, 2y-3 \leq x \leq \frac{1}{2}y + \frac{3}{2} \Big\},
% 	      \end{align}
% 	      which, again, is due the fact that we first face to the line $(AC)$ and then $(BC)$
% 	      while following the $x$-axis.
% 	      Therefore, we obtain 
% 	      \begin{align}
% 		      \bigintsss_{\mathcal{M}}f(x,y)\,d\lambda_{2}
% 		       & = \bigintsss_{\mathcal{M}_3}f(x,y)\,d\lambda_{2}
% 		      + \bigintsss_{\mathcal{M}_4}f(x,y)\,d\lambda_{2}
% 		      \notag                                                                                 \\
% 		       & = \bigintsss_{\mathbb{R}} 
% 		      ( \bigintsss_{(\mathcal{M}_3)_y} f(x,y)\,dx )\,dy
% 		      + \bigintsss_{\mathbb{R}}
% 		      ( \bigintsss_{(\mathcal{M}_4)_y} f(x,y)\,dx )\,dy
% 		      \notag                                                                                 \\
% 		       & = \bigintsss_{1=y_B}^{2=y_A} ( \bigintsss_{-y+3}^{y/2+3/2} f(x,y)\,dx ) \,dy \notag \\
% 		       & \qquad\qquad\qquad
% 		      + \bigintsss_{2=y_A}^{3=y_C} ( \bigintsss_{2y-3}^{y/2+3/2} f(x,y)\,dx ) \,dy
% 	      \end{align}
% 	      which will results in $3/2$ when $f(x,y)=1$.
% \end{enumerate}
